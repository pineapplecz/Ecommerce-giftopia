  ...
  <div class="right-side">
    <div class="login-box">
      ...
      <form method="POST" action="{{ route('login') }}">
        ...
        <a href="{{ route('login') }}" class="text-link">Lupa Password?</a>
      ...
      <div class="social-login">
        <a href="#"><img src="{{ asset('14.png') }}" alt="Login Google"></a>
        <a href="#"><img src="{{ asset('15.png') }}" alt="Login Facebook"></a>
        <a href="#"><img src="{{ asset('16.png') }}" alt="Login Apple"></a>
      </div>

      <div class="text-center-small mt-3">Belum punya akun?</div>
      <a href="{{ route('register') }}">
        <button class="btn btn-outline-dark mt-2 w-100">Daftar</button>
      </a>
    </div>
  </div>
</div>
